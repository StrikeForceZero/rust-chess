...
#[inline]
pub const fn set_pos(mut bitboard: BitBoardConst, board_position: BoardPosition, value: bool) -> BitBoardConst {
...
impl BitBoardConst {
    ...
    #[inline]
    pub const fn set_pos(mut self, board_position: BoardPosition, value: bool) -> Self {
    ...
    #[inline]
    pub const fn set(mut self, index: usize, value: bool) -> Self {
